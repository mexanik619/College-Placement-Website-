...
export default function Dashboard() {
  ...
  return (
    <div className="p-4" style={{ backgroundColor: "#f8d7da", minHeight: "calc(100vh - 4rem)" }}>
      <h1 className="text-2xl font-bold mb-4 text-center" style={{ color: "#000000" }}>Placement Portal Dashboard</h1>
      ...
      {activeTab === "company" && (
        <div className="space-y-4">
          <Card style={{ backgroundColor: "#fab1a0", borderColor: "#e17055" }}>
            <CardContent>
              <h2 className="text-xl font-semibold mb-4" style={{ color: "#000000" }}>Register a Company</h2>
          ...
          <Card style={{ backgroundColor: "#fab1a0", borderColor: "#e17055" }}>
            <CardContent>
              <h2 className="text-xl font-semibold mb-4" style={{ color: "#000000" }}>Post a Job</h2>
        ...
        <Card style={{ backgroundColor: "#fab1a0", borderColor: "#e17055" }}>
          <CardContent>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold" style={{ color: "#000000" }}>Application Tracking</h2>
              
              {/* Filter */}
              <div className="flex items-center gap-2">
                <span className="text-sm" style={{ color: "#000000" }}>Filter by:</span>
                <select 
            ...
            {/* Applications List */}
            {isLoading ? (
              <p className="text-center py-4" style={{ color: "#000000" }}>Loading applications...</p>
            ) : filteredApplications.length === 0 ? (
              <p className="text-center py-4" style={{ color: "#000000" }}>No applications found</p>
            ) : (
              <div className="space-y-4">
                {filteredApplications.map((app) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <h3 className="font-semibold" style={{ color: "#000000" }}>{app.student_name}</h3>
                        <p className="text-sm" style={{ color: "#000000" }}>Applied for: {app.job_title}</p>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      <Button 
                        ...
                        style={{ backgroundColor: "#74b9ff", color: "#000000" }}
                      >
                        Shortlist
                      </Button>
                      <Button 
                        ...
                        style={{ backgroundColor: "#a29bfe", color: "#000000" }}
                      >
                        Schedule Interview
                      </Button>
                      <Button 
                        ...
                        style={{ backgroundColor: "#55efc4", color: "#000000" }}
                      >
                        Select
                      </Button>
                      <Button 
                        ...
                        style={{ backgroundColor: "#ff7675", color: "#000000" }}
                      >
                        Reject
                      </Button>
                    </div>
